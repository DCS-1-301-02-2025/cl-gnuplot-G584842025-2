...
plot "weather2025.csv" using 1:2 w l title "最高気温","weather2025.csv" using 1:3 w l title "最高気温(平年)","weather2025.csv" using 1:4 w l title "最高気温","weather2025.csv" using 1:5 w l title "最高気温(平年)"
```
